...
class Player extends Phaser.GameObjects.Image {
    constructor(scene, x, y, motion) {
        super(scene, x, y, 'player', directions.offset);
...
class Example extends Phaser.Scene
{
    ...
    preload ()
    {
        ...
        this.load.spritesheet('player', 'assets/zombie.png', { frameWidth: 128, frameHeight: 128 });
    ...
    create ()
    {
        ...
        this.buildMap();
        this.placeHouses();
        player = this.add.existing(new Player(this, 330, 500, 'idle'));
    ...
    update ()
    {
        ...
        if (cursors.left.isDown) {
            //  Move to the left
            player.x -= player.direction.x * player.speed;//this.x += this.direction.x * this.speed;
